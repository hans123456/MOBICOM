...
public class FetchUpcomingEvents extends AsyncTask<Void, Void, ArrayList<Event>> {

	private final String TAG = "FetchUpcomingEvents";
	private AsyncFetchListTaskCompleteListener<ArrayList<Event>> listener;
	
	public FetchUpcomingEvents(AsyncFetchListTaskCompleteListener<ArrayList<Event>> listener) {
	...
	protected ArrayList<Event> doInBackground(Void... arg0) {
		...
		try {
			...
			Document doc = Jsoup.connect(HTML.website + HTML.upcoming_events).userAgent("Mozilla").get();
