...
public class CreateEventActivity$$ViewInjector {
  public static void inject(Finder finder, final com.example.plan8_ui.Events.CreateEventActivity target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131492966, "field 'title_edit_text'");
    target.title_edit_text = (android.widget.EditText) view;
    view = finder.findRequiredView(source, 2131492972, "field 'description_edit_text'");
    target.description_edit_text = (android.widget.EditText) view;
    view = finder.findRequiredView(source, 2131492968, "field 'time_start_edit_text' and method 'onClickTimeStart'");
    ...
    view = finder.findRequiredView(source, 2131492967, "field 'date_start_edit_text' and method 'onClickDateStart'");
    ...
    view = finder.findRequiredView(source, 2131492969, "field 'date_end_edit_text' and method 'onClickDateEnd'");
    ...
    view = finder.findRequiredView(source, 2131492971, "field 'location_edit_text'");
    ...
    view = finder.findRequiredView(source, 2131492970, "field 'time_end_edit_text' and method 'onClickTimeEnd'");
