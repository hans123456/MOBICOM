...
public class DeclinedEventsFragment$$ViewInjector {
  public static void inject(Finder finder, final com.example.plan8_ui.Events.DeclinedEventsFragment target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131493028, "field 'events_list_view' and method 'onItemClick'");
  ...
  public static void reset(com.example.plan8_ui.Events.DeclinedEventsFragment target) {
