...
public class EventViewHolder$$ViewInjector {
  public static void inject(Finder finder, final com.example.plan8_ui.Model.EventViewHolder target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131493028, "field 'date_start_text_view'");
    target.date_start_text_view = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131493030, "field 'date_end_text_view'");
    target.date_end_text_view = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131493033, "field 'location_text_view'");
    target.location_text_view = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131493032, "field 'title_text_view'");
    target.title_text_view = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131493029, "field 'time_start_text_view'");
    target.time_start_text_view = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131493031, "field 'time_end_text_view'");
